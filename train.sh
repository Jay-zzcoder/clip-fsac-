...
## train on the VisA dataset
    ...
    CUDA_VISIBLE_DEVICES=0 python train.py --dataset visa \
    --data_path  /data/sys/data/visa-fewshot/VISA-8cls/ --save_path ./results/mvtec_${base_dir}/few_shot_${few_shots[few_num]} \
